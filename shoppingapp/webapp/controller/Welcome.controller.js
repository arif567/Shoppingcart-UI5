sap.ui.define([
    ...
    function (BaseController, cart, JSONModel, Filter, FilterOperator, formatter) {
        ...
        return BaseController.extend("shoppingapp.controller.Welcome", {
            ...
            onInit: function () {
                var oViewModel = new JSONModel({
                    welcomeCarouselShipping: 'shoppingapp/img/Shipping_273087.jpg',
                    welcomeCarouselInviteFriend: 'shoppingapp/img/InviteFriend_276352.jpg',
                    welcomeCarouselTablet: 'shoppingapp/img/Tablet_275777.jpg',
                    welcomeCarouselCreditCard: 'shoppingapp/img/CreditCard_277268.jpg',
                    Promoted: [],
                    Viewed: [],
                    Favorite: [],
                    Currency: "EUR"
                ...
                if (sRouteName !== "product" && sRouteName !== "cartProduct") {
                    ...
                    if (!aPromotedData.length) {
                        ...
                        Object.keys(this._mFilters).forEach(function (sFilterKey) {
                            oModel.read("/ZA_EPM_ProductFed02", {
