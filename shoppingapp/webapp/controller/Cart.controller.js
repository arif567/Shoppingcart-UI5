sap.ui.define([
    ...
    function (BaseController,
        ...
        return BaseController.extend("shoppingapp.controller.Cart", {
            ...
            onInit: function () {
                ...
                this._oRouter.getRoute("RouteProductCart").attachPatternMatched(this._routePatternMatched, this);
                this._oRouter.getRoute("RouteComparison").attachPatternMatched(this._routePatternMatched, this);
            ...
            _showProduct: function (oItem) {
                ...
                this._oRouter.navTo(bCartVisible ? "RouteProductCart" : "product", {
                    id: oEntry.Category,
            ...
            onProceedButtonPress: function () {
                this.getRouter().navTo("RouteCheckout");
            }
        });
    });
