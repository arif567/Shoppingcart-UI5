sap.ui.define([
    ...
    function (BaseController,Controller,formatter) {
        ...
        return BaseController.extend("shoppingapp.controller.Comparison", {
            formatter: formatter,
            onInit: function () {
                this._oRouter = this.getRouter();
                this._oRouter.getRoute("RouteComparison").attachPatternMatched(this._onRoutePatternMatched, this);
                this._oRouter.getRoute("RouteComparisonCart").attachPatternMatched(this._onRoutePatternMatched, this);
            },
            _onRoutePatternMatched: function (oEvent) {
                ...
                function updatePanel (iWhich, sId) {
                    ...
                    if (sId){
                        var sPath = "/ZA_EPM_Product02('" + sId + "')";
                        oPanel.bindElement({
                            path: sPath
                        });
            ...
            onRemoveComparison: function (oEvent){
                ...
                this.getRouter().navTo("RouteComparison", {
                    id : sCategory,
            ...
            onToggleCart: function (oEvent) {
                ...
                this.getRouter().navTo(bPressed ? "RouteComparisonCart" : "RouteComparison", {
                    id: sCategory,
                    item1Id: sItem1Id,
                    item2Id: sItem2Id
                });
